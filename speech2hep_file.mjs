...
async function callModel (path) {
    ...
    if(path.endsWith('.meta')) { 
        ...
        let model = cp.execFile('./node_modules/whisper-node/lib/whisper.cpp/main', ['-ml', '20', '-l', 'auto', '-m', './node_modules/whisper-node/lib/whisper.cpp/models/ggml-base.en.bin', '-sow', newpath], {
            shell: true,
            timeout: 180000,
        },
        handleModelResult
 ...
 * @param {Buffer} buffer
 */
async function handleModelResult (err, data) {
